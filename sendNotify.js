...
if (process.env.HS_NOTIFY_CONTROL && process.env.HS_NOTIFY_CONTROL==false) {
  dyhsNotifyControl = process.env.HS_NOTIFY_CONTROL;
}
if (process.env.TTJS_NOTIFY_CONTROL && process.env.TTJS_NOTIFY_CONTROL==false) {
  ttjsNotifyControl = process.env.TTJS_NOTIFY_CONTROL;
}
