...
############## 圈x
#githubAC获取body
https:\/\/github\.com\/* url script-request-body 
############## loon
#githubAC获取body
http-request https:\/\/github\.com\/* script-path=
############## surge
#githubAC获取body
githubACbody = type=http-request,pattern=https:\/\/github\.com\/*,requires-body=1,max-size=0,script-path=
